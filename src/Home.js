...
const Home = () => {
    ...
    return (
        <div className="w3-row home">
            {data &&  <Slide easing="ease">
                {data.projects.map((project, index)=> (
                    <div className="each-slide w3-display-container w3-center w3-black" key={index}>
            ...
            <div className="dark-grey" id="contatos">
                ...
                <ul class="w3-ul light-grey w3-text-white w3-card-4 link">
                    ...
                    <li class="w3-padding"><Image source="/img/icon4.png" style={styles.icon}/><a href="github.com/Fafnir-D3">github.com/Fafnir-D3 </a></li>
                    <li class="w3-padding"><Image source="/img/icon5.png" style={styles.icon}/><a href="www.linkedin.com/in/brendan-buckley-702214220/">/brendan-buckley-702214220 </a></li>
                </ul>
                </div>
            </div>
